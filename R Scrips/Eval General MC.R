...
## LOAD DATA: 
my_policy = py_load_object("C:\\006 Learning\\RL\\MC RESULTS\\policy.pickle")
my_avalue = py_load_object("C:\\006 Learning\\RL\\MC RESULTS\\action_value.pickle")


baseline_reward <- py_load_object("C:\\006 Learning\\RL\\MC RESULTS\\baseline_reward.pickle")
sarsa_reward <- py_load_object("C:\\006 Learning\\RL\\MC RESULTS\\training_rewards.pickle")
eval_rew = py_load_object("C:\\006 Learning\\RL\\MC RESULTS\\evaluated_rewards.pickle")
